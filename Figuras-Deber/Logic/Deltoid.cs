...
namespace Figuras_Deber.Logic
{
    internal class Deltoid
    {
        ...
        {
            // En un deltoide convexo, hay dos pares de lados iguales
            // Calculamos los dos lados diferentes del deltoide
            float a = (float)Math.Sqrt(
                Math.Pow(mDiagonalMajor / 2, 2) + Math.Pow(mDiagonalMinor / 4, 2)
            );
        ...
        {
            // El área de un deltoide es la mitad del producto de sus diagonales
        ...
        public void PlotShape(PictureBox picCanvas)
        {
            ...
            points[0] = new PointF(centerX, centerY - scaledDiagonalMinor / 4);  
            points[1] = new PointF(centerX + scaledDiagonalMajor / 2, centerY);  
            points[2] = new PointF(centerX, centerY + 3 * scaledDiagonalMinor / 4);  
